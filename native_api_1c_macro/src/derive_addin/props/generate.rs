...
pub fn param_ty_to_ffi_set(
    ...
    match param_type {
        ...
        PropType::I32 => {
            quote! {
                native_api_1c::native_api_1c_core::ffi::provided_types::ParamValue::I32(inner_value) => {
                    self.#param_path = inner_value.clone()
                },
            }
        }
        PropType::F64 => {
            quote! {
                native_api_1c::native_api_1c_core::ffi::provided_types::ParamValue::F64(inner_value) => {
                    self.#param_path = inner_value.clone()
                },
            }
        }
        PropType::String => {
            quote! {
                native_api_1c::native_api_1c_core::ffi::provided_types::ParamValue::Str(inner_value) => {
                    self.#param_path
        ...
        PropType::Blob => {
            quote! {
                native_api_1c::native_api_1c_core::ffi::provided_types::ParamValue::Blob(inner_value) => {
                    self.#param_path = inner_value.clone()
                },
            }
        }
