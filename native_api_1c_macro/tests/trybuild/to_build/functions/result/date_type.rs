...
pub struct MyAddIn {
    ...
    pub my_function: fn(&Self, chrono::NaiveDateTime) -> Result<chrono::NaiveDateTime, ()>,
}
...
impl MyAddIn {
    ...
    fn my_function_inner(&self, arg: chrono::NaiveDateTime) -> Result<chrono::NaiveDateTime, ()> {
        Ok(arg)
    }
}
